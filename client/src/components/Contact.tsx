        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="space-y-8 mb-12">
              <a href="mailto:anashmoosa@gmail.com" className="flex items-center justify-center space-x-4 text-foreground hover:text-primary transition-colors group">
                ...
                <span className="text-xl font-medium">anashmoosa@gmail.com</span>
              </a>
